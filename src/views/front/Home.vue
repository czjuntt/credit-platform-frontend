      ...
      <section class="quick-section">
        <div class="page-container">
          <div class="quick-grid">
            <router-link to="/policies" class="quick-card">
            ...
            <router-link to="/cases" class="quick-card">
            ...
            <router-link to="/contacts" class="quick-card">
